...
using ZPMC_MES.Api.Entities.QueryModels.DncPermission;
using ZPMC_MES.Api.Extensions;
using ZPMC_MES.Api.Extensions.AuthContext;
using ZPMC_MES.Api.Models.Response;
using ZPMC_MES.Api.RequestPayload.Rbac.Permission;
using ZPMC_MES.Api.Utils;
...
using ZPMC_MES.Api.Extensions.CustomException;

namespace ZPMC_MES.Api.Controllers.Api.V1.Rbac
{
    /// <summary>
    /// 权限控制器
    /// </summary>
    ...
    public class PermissionController : Controller
    {
        ...
        public PermissionController(ZPMC_MESDbContext dbContext, IMapper mapper)
        {
