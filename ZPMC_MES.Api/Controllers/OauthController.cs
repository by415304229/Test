...
using ZPMC_MES.Api.Auth;
using static ZPMC_MES.Api.Entities.Enums.CommonEnum;

namespace ZPMC_MES.Api.Controllers
{
    /// <summary>
    /// 
    /// </summary>
    ...
    public class OauthController : ControllerBase
    {
        ...
        public OauthController(IOptions<AppAuthenticationSettings> appSettings, ZPMC_MESDbContext dbContext)
        {
